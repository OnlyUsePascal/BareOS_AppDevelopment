...
#define MBOX_TAG_GETMACADDR 0x00010003 // Get MAC address
...
//Get board model
/* Function Prototypes */
#define MBOX_UNIT_SZ 4 //4 byte for each element of mbuf

int mbox_call(unsigned int buffer_addr, unsigned char channel);
void mbox_setup (unsigned int tagId, unsigned int reqSz, unsigned int resSz, unsigned int **resData);
